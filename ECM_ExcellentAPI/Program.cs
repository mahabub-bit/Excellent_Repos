using ECM_ExcellentAPI;
using ECM_ExcellentAPI.Data;
using ECM_ExcellentAPI.Repository;
...
builder.Services.AddScoped<ISuppilerRepository, SupplierRepository>();
builder.Services.AddScoped<ICategoryTypeRepository, CategoryTypeRepository>();
builder.Services.AddScoped<IProductRepository, ProductRepository>();
builder.Services.AddScoped<IProductRateHistoryRepository, ProductRateHistoryRepository>();
